...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.resize(430, 141)
        self.buttonBox = QtWidgets.QDialogButtonBox(Dialog)
        self.buttonBox.setGeometry(QtCore.QRect(30, 80, 341, 31))
        ...
        self.lineEdit_b.setGeometry(QtCore.QRect(180, 30, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.lineEdit_c.setGeometry(QtCore.QRect(310, 30, 81, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
        ...
        self.label_3.setGeometry(QtCore.QRect(280, 30, 31, 31))
        font = QtGui.QFont()
        font.setFamily("Times New Roman")
        font.setPointSize(14)
